...
public class BiodataProgrammer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inputCleanCode = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        inputDebugging = new javax.swing.JTextField();
        ...
        inputDebugging.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inputDebuggingActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(inputKnowledge)
                    .addComponent(inputDebugging)
                    .addComponent(inputCleanCode))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel7)
                    .addComponent(inputCleanCode, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel8)
                    .addComponent(inputDebugging, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(17, Short.MAX_VALUE))
        );
    ...
    private void inputDebuggingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputDebuggingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_inputDebuggingActionPerformed
    ...
    private void btnCekNilaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCekNilaiActionPerformed
        ...
        try {
            ...
            Double knowledge = Double.parseDouble(inputKnowledge.getText());
            Double cleanCode = Double.parseDouble(inputCleanCode.getText());
            Double debugging = Double.parseDouble(inputDebugging.getText());

            if (ipk > 4 || ipk < 0) {
                throw new Exception("Input IPK tidak valid!");
            }

            if (knowledge > 100 || cleanCode > 100 || debugging > 100) {
                throw new Exception("Input melebihi batas maksimum!");
            } else if (knowledge < 0 || cleanCode < 0 || debugging < 0) {
                throw new Exception("Input kurang dari batas minimum!");
            } else {
                Programmer programmer = new Programmer(nama, asalKampus, ipk, knowledge, cleanCode, debugging);
                new HasilSeleksiProgrammer(programmer);
                this.dispose();
            }
    ...
    private javax.swing.JTextField inputCleanCode;
    private javax.swing.JTextField inputDebugging;
