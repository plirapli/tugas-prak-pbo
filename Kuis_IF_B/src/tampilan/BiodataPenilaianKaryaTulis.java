...
public class BiodataPenilaianKaryaTulis extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel2Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addGap(18, 18, 18)
        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addComponent(inputTataBahasa)
          .addComponent(inputEyd, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
  ...
  private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
    ...
    try {
      ...
      // Penilaian
      double tataBahasa = Double.parseDouble(inputTataBahasa.getText());
      ...
      if (tataBahasa > 100 || tataBahasa < 0 || eyd > 100 || eyd < 0 || struktur > 100 || struktur < 0 || kreativitas > 100 || kreativitas < 0) {
        throw new Exception("Input tidak valid!");
      } else {
        KaryaTulis karyaTulis = new KaryaTulis(tataBahasa, eyd, struktur, kreativitas);
        new HasilPenilaian(new User(nama, nim, jurusan), karyaTulis.getHasil());
        this.dispose();
      }
    } catch (Exception e) {
